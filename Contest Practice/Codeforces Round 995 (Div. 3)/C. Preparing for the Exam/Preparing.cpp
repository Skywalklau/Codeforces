...
// solve time ~ 20 mins 
// Boring problem. 
// The answer is just a simple observation.
// if k == n, the we can cover all the problems regardless of 
// whether we remove a problem from any list.
// if k == n-1, then there is only 1 list we can do, and that list
// will be the one containing the problem we don't have the answer for.
// if k < n-1, then its impossible for us to do anything, because
// no matter what we don't have enough answers to answer all n-1
// questions.
