...
// Hence ab <= n-a-1, and also a+b<x.
// We can do this, because for a fixed a, since ab <= n-a-1, then
// b <= (n-a-1)/a for every a up to min(n,x).
// More clearly, its logarithmic.
// Eg. n=20.
// for a=1, there is (20-1-1)/1 operations
// a=2 has (20-2-1)/2 operations
// a=3 has (20-3-1)/3 operations
// a=4 has (20-4-1)/4 operations
