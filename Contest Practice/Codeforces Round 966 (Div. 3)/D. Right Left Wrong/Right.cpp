...
// solve time ~ 10 mins
// Yea idk man its just 2 pointers + greedy.
// Like, they want to maximize the score, so the greedy observation
// is to realize that we always wanna pair the leftmost L with the 
// rightmost R.
// This way we can always maximize our prefix sums.
// We can do this because all the elements are positive.
