...
// solve time ~ 23 mins
// Boring problem. Its just greedy.
// What is the best way to form the longest sequence satisfying the
// conditions?
// The idea is that we just need to minimize the gap.
// we always start at i=l, then the gap is 1 initially.
// then our next number is i=i+gap.
// then increase our gap by 1 (because this way we get a bigger
// difference, satisfying condition 2).
// So, we just need to do this and thats the solution.
