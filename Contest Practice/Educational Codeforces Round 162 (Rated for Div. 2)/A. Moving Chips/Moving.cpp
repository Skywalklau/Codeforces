...
// solve time ~ 5 mins
// I mean, its an irrelevant problem.
// We can only shift all the chips to the left, so just loop from the back
// to the front.
// We just need to take the difference between every two 1 chips to count
// the number of zeros in between them.
