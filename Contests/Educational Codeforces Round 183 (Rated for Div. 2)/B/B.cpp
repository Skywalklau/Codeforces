...
void solve() {
    ...
    vch result(n, '+');
    for (int i=0; i<cnt0; i++) result[i] = '-';
    for (int i=0; i<cnt1; i++) result[n-i-1] = '-';

    if (cnt2 < n-cnt1-cnt0){
        for (int i=0; i<cnt2; i++) result[i+cnt0] = '?';
        for (int i=0; i<cnt2; i++) result[n-cnt1-i-1] = '?';
    }
    else{
        for (int i=0; i<cnt2; i++) result[i+cnt0] = '-';
    }
    ...
    str ans = "";
    for (int i=0; i<n; i++) ans += result[i];
